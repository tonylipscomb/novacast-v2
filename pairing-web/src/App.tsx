...
export function App() {
  ...
  if (state === 'success') {
    return <main className="shell"><section className="card success"><Brand /><div className="successIcon" aria-hidden="true">âœ“</div><p className="eyebrow">DEVICE AUTHORIZATION COMPLETE</p><h1>Provider connected</h1><p>Authorization was sent to your NovaCast device. Return to the TV; it should open Home within a few seconds.</p><button onClick={() => window.location.reload()}>Pair another device</button></section></main>;
  }
...
function ActivationPage() {
  ...
  if (state === 'success') return <main className="shell"><section className="card success"><Brand /><div className="successIcon" aria-hidden="true">âœ“</div><p className="eyebrow">ACTIVATION COMPLETE</p><h1>NovaCast activated</h1><p>Your TV can now check its beta access. Return to the device to continue.</p><button onClick={() => window.location.href = '/pair'}>Continue to pairing</button></section></main>;
