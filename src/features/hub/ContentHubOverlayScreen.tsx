      ...
      <Animated.View
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.manageRow}>
              <Pressable
                ...
                onPress={openPairing}
                style={[styles.manageButton, novaTvFocus.base, focusedId === 'manage' && novaTvFocus.active]}>
          ...
          <Pressable
            ...
            onPress={goHome}
            style={[styles.closeHub, novaTvFocus.base, focusedId === 'close-hub' && novaTvFocus.active]}>
...
function QuickAction({ icon, title, subtitle, focused, onFocus, onBlur, onPress }: QuickActionProps) {
  return (
    <Pressable
      ...
      onBlur={onBlur}
      onPress={onPress}
      style={[styles.quickCard, novaTvFocus.base, focused && novaTvFocus.active]}>
