...
export function mergeLocalAndProviderMovieDetail(
  ...
  return {
    ...
    detail: {
      ...
      containerExtension: extension,
      videoCodec: provider.videoCodec || local.videoCodec,
      videoWidth: provider.videoWidth ?? local.videoWidth,
      videoHeight: provider.videoHeight ?? local.videoHeight,
      videoBitrate: provider.videoBitrate ?? local.videoBitrate,
      directSource: provider.directSource || local.directSource,
      seasons: [],
      episodes: [],
    },
  };
