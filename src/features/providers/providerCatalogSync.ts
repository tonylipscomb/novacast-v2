      ...
      console.info(
        '[NovaCast Movies Full Dump Sync] ' +
          JSON.stringify({
            ...
            rawCategoryIdFieldPresentCount: fullDumpResult.stats?.categoryIdFieldPresentCount ?? null,
            rawCategoryIdsFieldPresentCount: fullDumpResult.stats?.categoryIdsFieldPresentCount ?? null,
            rawDistinctCategoryIds: fullDumpResult.stats?.distinctCategoryIds ?? null,
            rawTopCategoryFrequencies: fullDumpResult.stats?.topCategoryFrequencies ?? [],
            filteringReliable: false,
            filterStatus,
            filterReason,
