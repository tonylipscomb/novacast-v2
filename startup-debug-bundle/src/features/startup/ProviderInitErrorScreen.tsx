        ...
        {isSwitchingProvider ? (
          ...
          <View style={styles.actions}>
            <Pressable
              ...
              onPress={() => void retry()}
              style={[styles.button, styles.primaryButton, focusedAction === 'retry' && styles.focused]}>
            ...
            <Pressable
              ...
              style={[styles.button, styles.secondaryButton, focusedAction === 'pair' && styles.focused]}>
